...
ebookcoinApp = angular.module('ebookcoinApp', ['ui.router', 'btford.modal', 'ngTable', 'ngAnimate',  'chart.js', 'btford.socket-io', 'ui.bootstrap', 'ngClipboard', 'angular.filter', 'gettext']);

ebookcoinApp.config(["ngClipProvider",
    "$locationProvider",
    "$stateProvider",
    "$urlRouterProvider",
